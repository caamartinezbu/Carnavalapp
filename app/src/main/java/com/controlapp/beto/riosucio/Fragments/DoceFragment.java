...
public class DoceFragment extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            view = inflater.inflate(R.layout.fragment_doce, container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(
                new LatLng(5.418709, -75.702233), 16));
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.418709, -75.702233))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_inicio))
                .title("Inicio Desfile"));

        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.421036, -75.704321))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_final))
                .title("Fin Desfile"));
        //Dibujo de recorrido
        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.418709, -75.702233))
                .add(new LatLng(5.420354, -75.701200))
                .add(new LatLng(5.421721, -75.703497))
                .add(new LatLng(5.422064, -75.704163))
                .add(new LatLng(5.421402, -75.704340))
                .add(new LatLng(5.421335, -75.704249))
                .add(new LatLng(5.421036, -75.704321));
                lineas.width(5);
