...
public class DiecisieteFragment extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            view = inflater.inflate(R.layout.fragment_diecisiete, container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(
                new LatLng(5.420657, -75.702536), 16));
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.421283, -75.703978))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_inicio))
                .title("Inicio Desfile"));

        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.422312, -75.699486))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_final))
                .title("Fin Desfile"));
        //Dibujo de recorrido
        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.421283, -75.703978))
                .add(new LatLng(5.421196, -75.703674))
                .add(new LatLng(5.421722, -75.703501))
                .add(new LatLng(5.419924, -75.700450))
                .add(new LatLng(5.421058, -75.699864))
                .add(new LatLng(5.421680, -75.699470))
                .add(new LatLng(5.421995, -75.699209))
                .add(new LatLng(5.422312, -75.699486));
                lineas.width(5);
