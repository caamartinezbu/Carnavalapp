...
public class GmapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.420979, -75.702241))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_inicio))
                .title("Inicio"));

        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.420240, -75.702691))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_final))
                .title("Fin"));
        //Dibujo con Lineas

        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.420979, -75.702241))
                .add(new LatLng(5.421710, -75.703498))
                .add(new LatLng(5.422046, -75.704152))
                .add(new LatLng(5.421381, -75.704329))
                .add(new LatLng(5.421354, -75.704235))
                .add(new LatLng(5.420713, -75.704385))
                .add(new LatLng(5.420587, -75.703846))
                .add(new LatLng(5.420859, -75.703756))
                .add(new LatLng(5.420240, -75.702691));
        lineas.width(5);
