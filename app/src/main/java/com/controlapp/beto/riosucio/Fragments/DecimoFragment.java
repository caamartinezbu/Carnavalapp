...
public class DecimoFragment extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            view = inflater.inflate(R.layout.fragment_decimo, container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.420704, -75.704404))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_inicio))
                .title("Inicio Desfile"));

        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.422297, -75.699468))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_final))
                .title("Fin Desfile"));
        //Dibujo de recorrido
        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.420704, -75.704404))
                .add(new LatLng(5.420581, -75.703843))
                .add(new LatLng(5.420854, -75.703752))
                .add(new LatLng(5.419153, -75.700882))
                .add(new LatLng(5.421397, -75.699667))
                .add(new LatLng(5.421780, -75.699400))
                .add(new LatLng(5.421989, -75.699210))
                .add(new LatLng(5.422297, -75.699468));
                lineas.width(5);
