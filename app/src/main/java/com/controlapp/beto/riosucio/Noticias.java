        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                noticiasRecicler.addOnItemTouchListener(
                        new RecyclerItemClickListener(Noticias.this, noticiasRecicler ,new RecyclerItemClickListener.OnItemClickListener() {
                            @Override public void onItemClick(View view, int position) {

                                Intent visual = new Intent(Noticias.this, DefaultEvent.class);
                                visual.putExtra("event_id", position + 1);
                                startActivity(visual);

                                System.out.println("----rtytr-yrt-yrt-yrt-yrt-yrt-yrt-yt-y");
