...
public class DecimoPrimeroFragment extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            view = inflater.inflate(R.layout.fragment_decimoprimero, container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.424411, -75.703603))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_inicio))
                .title("Inicio Desfile"));

        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.420289, -75.702756))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_final))
                .title("Fin Desfile"));
        //Dibujo de recorrido
        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.424411, -75.703603))
                .add(new LatLng(5.423700, -75.703782))
                .add(new LatLng(5.422625, -75.701849))
                .add(new LatLng(5.421257, -75.702710))
                .add(new LatLng(5.421721, -75.703501))
                .add(new LatLng(5.420855, -75.703751))
                .add(new LatLng(5.420289, -75.702756));
                lineas.width(5);
