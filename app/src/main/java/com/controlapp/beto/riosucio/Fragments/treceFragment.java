...
public class treceFragment extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            view = inflater.inflate(R.layout.fragment_trece, container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.421722, -75.703500))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_inicio))
                .title("Inicio Desfile"));

        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.422341, -75.699508))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_final))
                .title("Fin Desfile"));
        //Dibujo de recorrido
        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.421722, -75.703500))
                .add(new LatLng(5.419918, -75.700450))
                .add(new LatLng(5.421065, -75.699864))
                .add(new LatLng(5.421393, -75.699673))
                .add(new LatLng(5.421704, -75.699453))
                .add(new LatLng(5.421998, -75.699212))
                .add(new LatLng(5.422341, -75.699508));
                lineas.width(5);
