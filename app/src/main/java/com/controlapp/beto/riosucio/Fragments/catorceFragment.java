...
public class catorceFragment extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            view = inflater.inflate(R.layout.fragment_catorce, container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(
                new LatLng(5.418823, -75.705034), 16));
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.418823, -75.705034))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_inicio))
                .title("Inicio Desfile"));

        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.420288, -75.702764))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_final))
                .title("Fin Desfile"));
        //Dibujo de recorrido
        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.418823, -75.705034))
                .add(new LatLng(5.419339, -75.704925))
                .add(new LatLng(5.420031, -75.704708))
                .add(new LatLng(5.420681, -75.704530))
                .add(new LatLng(5.420706, -75.704397))
                .add(new LatLng(5.420579, -75.703840))
                .add(new LatLng(5.421726, -75.703497))
                .add(new LatLng(5.421261, -75.702706))
                .add(new LatLng(5.420512, -75.703158))
                .add(new LatLng(5.420288, -75.702764));
                lineas.width(5);
