...
public class QuintoFragment extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            view = inflater.inflate(R.layout.fragment_quinto, container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.416284, -75.699265))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_inicio))
                .title("Inicio Desfile"));

        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.420291, -75.702785))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_final))
                .title("Fin Desfile"));
        //Dibujo de recorrido
        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.416284, -75.699265))
                .add(new LatLng(5.417213, -75.700073))
                .add(new LatLng(5.418196, -75.701468))
                .add(new LatLng(5.419928, -75.700444))
                .add(new LatLng(5.421720, -75.703496))
                .add(new LatLng(5.422054, -75.704161))
                .add(new LatLng(5.421424, -75.704335))
                .add(new LatLng(5.421325, -75.704260))
                .add(new LatLng(5.420708, -75.704394))
                .add(new LatLng(5.420595, -75.703850))
                .add(new LatLng(5.420860, -75.703753))
                .add(new LatLng(5.420291, -75.702785));
                lineas.width(5);
