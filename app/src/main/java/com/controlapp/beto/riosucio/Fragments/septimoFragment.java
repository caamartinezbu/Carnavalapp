...
public class septimoFragment extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            view = inflater.inflate(R.layout.fragment_septimo, container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.423686, -75.703774))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_inicio))
                .title("Inicio Desfile"));

        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.421024, -75.704327))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_final))
                .title("Fin Desfile"));
        //Dibujo de recorrido
        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.423686, -75.703774))
                .add(new LatLng(5.422629, -75.701852))
                .add(new LatLng(5.421265, -75.702706))
                .add(new LatLng(5.419918, -75.700459))
                .add(new LatLng(5.419152, -75.700895))
                .add(new LatLng(5.420858, -75.703748))
                .add(new LatLng(5.420578, -75.703841))
                .add(new LatLng(5.420711, -75.704402))
                .add(new LatLng(5.421024, -75.704327));
                lineas.width(5);
