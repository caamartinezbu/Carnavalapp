...
public class DieciseisFragment extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            view = inflater.inflate(R.layout.fragment_dieciseis, container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(
                new LatLng(5.422205, -75.701101), 16));
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.422205, -75.701101))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_inicio))
                .title("Inicio Desfile"));

        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.421044, -75.704327))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_final))
                .title("Fin Desfile"));
        //Dibujo de recorrido
        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.422205, -75.701101))
                .add(new LatLng(5.421365, -75.699689))
                .add(new LatLng(5.419913, -75.700448))
                .add(new LatLng(5.419155, -75.700893))
                .add(new LatLng(5.420857, -75.703752))
                .add(new LatLng(5.420580, -75.703839))
                .add(new LatLng(5.420706, -75.704401))
                .add(new LatLng(5.421044, -75.704327));
                lineas.width(5);
