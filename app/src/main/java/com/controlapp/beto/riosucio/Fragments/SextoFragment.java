...
public class SextoFragment extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            view = inflater.inflate(R.layout.fragment_sexto, container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //inicio y fin
        googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.422225, -75.701097))
        ...
        PolylineOptions lineas = new PolylineOptions()
                .add(new LatLng(5.422225, -75.701097))
                .add(new LatLng(5.421364, -75.699690))
                .add(new LatLng(5.419918, -75.700448))
                .add(new LatLng(5.421719, -75.703498))
                .add(new LatLng(5.420857, -75.703745))
                .add(new LatLng(5.420282, -75.702771));
                lineas.width(5);
